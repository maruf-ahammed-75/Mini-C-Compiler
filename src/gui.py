...
Place this file alongside lexer.py, parser.py, symbol_table.py and assembly_translator.py (or
update the import path if you named the translator module differently).
"""
...
class CompilerInterface:
    ...
    def __init__(self, window):
        ...
        # TokenScanner.__init__ calls initialize(); calling again is safe but unnecessary
        try:
...
"""
    ...
    def run_compilation(self):
        ...
        try:
            ...
            # If registry missing or not initialized, ignore
            pass
